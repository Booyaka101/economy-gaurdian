...
describe('player stats', () => {
  beforeAll(() => {
    ...
    if (process.env.EG_SQLITE_DEBUG !== undefined) {
      delete process.env.EG_SQLITE_DEBUG;
    }
    if (process.env.EG_SQLITE_RESET !== undefined) {
      ...
      realms: {
        "Twilight's Hammer": {
          Dronkbuffel: {
            postings: [],
            sales: [],
            payouts: [{ t: now - 100, itemId: 1, qty: 1, gross: 1000, cut: 50, net: 950 }],
          },
        },
        "Twilight'sHammer": {
          Dronkbuffel: {
            postings: [],
            sales: [],
            payouts: [{ t: now - 200, itemId: 2, qty: 2, gross: 2000, cut: 100, net: 1900 }],
          },
        },
      },
    };
